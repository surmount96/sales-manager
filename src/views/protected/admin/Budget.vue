<template>
  <div>
    <section class="bg-white border border-gray rounded-md" style="min-height:50vh">
      ...
      <table class="table-auto w-full">
        ...
        <tr class="border-b border-gray text-gray-base" v-for="budget in budgets" :key="budget.id">
          ...
          <td class="py-4 text-medium px-3 flex flex-wrap">
            <router-link :to="`/admin/budgets/${budget.id}/regions/targets`">
            ...
            <button @click="edit(budget)" class="text-blue-dark ml-4">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" />
                <path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd" />
              </svg>
            </button>
            <button @click="handleBudgetDelete(budget.id)" class="focus:outline-none ml-4">
      ...
      <pagination @pagePagination="getBudgets" :meta="meta"/>
    </section>
    <vue-final-modal
...
name: "Budget",
  ...
  async mounted(){
    ...
    // console.log(new Intl.NumberFormat().format(12345678900))
    // console.log('sasdsda')
  },
  components:{
    Pagination
  ...
  methods:{
    ...mapActions(['logout','fetchBudget','fetchBudgetTypes','fetchRegion','deleteSingleBudgets','storeBudget','updateSingleBudgets']),
