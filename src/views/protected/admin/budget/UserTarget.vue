      ...
      <div class="px-4 bg-white rounded-sm py-5">
        ...
        <table class="table w-full">
          <tr class="bg-gray-400 font-semibold">
            <td class="py-4 text-medium px-3 ">Agents</td>
...
export default {
  ...
  methods:{
    ...mapActions(['fetchBudget','fetchRegion','getUserTargets','createTargetForUser','updateTargetForUser','fetchAllUsers','fetchUsersInTerritory']),
