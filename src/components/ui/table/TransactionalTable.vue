    ...
    <div>
        <table class="w-full">
            <tr class="bg-gray-400 font-semibold">
                <td class="py-4 text-medium px-3 ">Agent Name</td>
                ...
                <td class="py-4 text-medium px-3">Date</td>
            </tr>
            <!--tr class="border-b border-gray text-gray-base" v-for="user in users" :key="user.id">
                ...
                <td class="py-4 text-medium px-3">{{ user.email }}-north</td>
                <td class="py-4 text-medium px-3">{{ user.role }}</td>
                <td class="py-4 text-medium px-3">{{ user.status }}</td>
                <td class="py-4 text-medium px-3">N1,583,000</td>
                <td class="py-4 text-medium px-3">9/12/2020</td>
            </!--tr -->
            <tr class="border-b border-gray text-gray-base">
                <td class="py-4 text-medium px-3 ">Samson Uchola</td>
                <td class="py-4 text-medium px-3">Ikorodu-north</td>
                <td class="py-4 text-medium px-3">Mainland</td>
                <td class="py-4 text-medium px-3">12,000</td>
                <td class="py-4 text-medium px-3">N1,583,000</td>
                <td class="py-4 text-medium px-3">9/12/2020</td>
            </tr>
            <tr class="border-b border-gray text-gray-base">
